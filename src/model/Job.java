...
public class Job implements Serializable, Comparable<Job> {
	...
	private static final int DIVIDE_DAYS = (1000 * 60 * 60 * 24);

	/** The job id. */
	private int jobId;
	
	/** The job name/description. */
	...
	public void setMaxNumLightVolunteers(int maxNumLightVolunteers) {
		...
		jobMaxNumLightVolunteers = maxNumLightVolunteers;
	...
	public void setMaxNumMediumVolunteers(int maxNumMediumVolunteers) {
		...
		jobMaxNumMediumVolunteers = maxNumMediumVolunteers;
	}
	...
	public void setMaxNumHeavyVolunteers(int maxNumHeavyVolunteers) {
		...
		jobMaxNumHeavyVolunteers = maxNumHeavyVolunteers;
	}
	...
	public boolean addLightVolunteer(Volunteer volunteer) {
		...
		if(!isLightVolunteersFull() && !getAllVolunteers().contains(volunteer)){
	...
	public boolean addMediumVolunteer(Volunteer volunteer) {
		...
		if(!isMediumVolunteersFull() && !getAllVolunteers().contains(volunteer)){
	...
	public boolean addHeavyVolunteer(Volunteer volunteer) {
		...
		if(!isHeavyVolunteersFull() && !getAllVolunteers().contains(volunteer)){
	...
	public static boolean isJobScheduleValid(Date startDate, Date endDate) {
		...
		//Constants
		int daysBetweenCurrentAndStartDate = (int)((startDate.getTime() - currentDate.getTime())/(DIVIDE_DAYS));
		int daysBetweenStartAndEndDate = (int)((endDate.getTime() - startDate.getTime())/(DIVIDE_DAYS));
